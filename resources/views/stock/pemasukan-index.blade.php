@extends('layout.main')
@section('title', 'Pemasukan Barang')
@section('content')
    <div class="main-content">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title-5 m-b-35">Pemasukan Barang</h3>
                            ...
                            <div class="table-data__tool-right">
                                @if(Auth::user()->isCs() || Auth::user()->isAdmin())
                                    <a class="au-btn au-btn-icon au-btn--tosca au-btn--small"
                                        href="{{ route('pemasukan.create') }}">
                                        <i class="zmdi zmdi-plus"></i>Tambah Pemasukan</a>
                                @endif
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                ...
                text: 'Data pemasukan barang yang dihapus tidak bisa dikembalikan!',
                icon: 'warning',
        ...
        $(document).on('click', '.btn-submit-approval', function() {
            ...
            Swal.fire({
                ...
                text: 'Pemasukan akan masuk ke approval queue',
                icon: 'info',
                showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '/pemasukan/' + id + '/submit-approval',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        success: function(data) {
        ...
        $(document).on('click', '.btn-approve', function() {
            ...
            Swal.fire({
                title: 'Approve Pemasukan?',
                text: 'Pemasukan akan disetujui dan stok akan terupdate',
                icon: 'success',
                showCancelButton: true,
                confirmButtonColor: '#00897B',
                cancelButtonColor: '#6c757d',
